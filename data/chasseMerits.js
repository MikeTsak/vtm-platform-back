...
const DIVISION_CHASSE = {
  ...
  4: ['hospital', 'gated_community', 'funerary'],
  5: ['hospital', 'apartment_towers'],
  6: ['nightlife', 'apartment_towers'],
  8: ['back_alleys', 'nightlife'],
  9: ['nightlife', 'funerary'],
  11: ['nightlife'],
  13: ['nightlife', 'funerary'],
  14: ['nightlife', 'funerary'],
  15: ['funerary'],
  16: ['nightlife'],
  17: ['hospital', 'funerary'],
  18: ['nightlife', 'hospital'],
  19: ['apartment_towers', 'nightlife', 'funerary'],
  20: ['apartment_towers'],
  21: ['funerary'],
  22: ['funerary'],
  23: ['gated_community'],
  ...
  25: ['apartment_towers'],
  27: ['gated_community', 'hospital', 'funerary'],
  28: ['nightlife', 'funerary'],
  29: ['hospital', 'apartment_towers', 'funerary'],
  30: ['funerary'],
  31: ['funerary'],
  32: ['funerary'],
  33: ['hospital', 'apartment_towers', 'shelter', 'funerary'],
  34: ['shelter', 'back_alleys'],
  35: ['hospital', 'gated_community', 'funerary'],
  36: ['hospital'],
  37: ['hospital', 'funerary'],
  38: ['funerary'],
  ...
  44: ['hospital'],
  45: ['hospital', 'funerary'],
  46: ['hospital', 'nightlife', 'gated_community', 'funerary'],
  48: ['hospital', 'funerary'],
  49: ['funerary'],
  83: ['back_alleys', 'shelter', 'funerary'],
  84: ['funerary'],
  85: ['back_alleys', 'shelter', 'funerary'],
